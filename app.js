...
let massageArorw = name => `Hello, ${name}!` ;
console.log(massageArorw('Allie'));
...
// let joeA = new Student2('Joe', 'Schmoe', 100);
// console.log(joeA);
...
;
console.log(Student.courseNameA());
// TODO: Uncomment the following line of code to see the output in the browser console
...
//when an arrow function is used this represents the father of object that defined .
